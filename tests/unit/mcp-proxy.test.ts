...
import { JSONRPCMessage, JSONRPCRequest, MethodParams, MethodResults } from '../../src/types/mcp.js';
...
(mockRegistry.sendMessage as jest.Mock).mockImplementation(async (serverId: string, message: JSONRPCRequest) => {
